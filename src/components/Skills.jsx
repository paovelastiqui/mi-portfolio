...
export const Skills = () => {
	...
	const [data, setData] = useState({
		...
		// Django: 'https://firebasestorage.googleapis.com/v0/b/portfolio-c9212.appspot.com/o/django.svg?alt=media&token=fed73115-e514-4951-9b25-4494637bd521',
		...
		Python: 'https://firebasestorage.googleapis.com/v0/b/portfolio-c9212.appspot.com/o/python.svg?alt=media&token=780a31f5-b60c-4abb-9139-e49f2095bf97'
	});

	return (
		<section className="skills">
			<div className="skills__title">
				<h1>SKILLS<span className="point">.</span></h1>
			</div>
